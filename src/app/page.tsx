    ...
    <main className="flex-grow">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex flex-col items-center text-center">
          ...
          <div className="mt-12 animate-bounce reveal-up active" style={{ transitionDelay: '0.4s' }}>
            <a href="#about" aria-label="Scroll down to About section" className="text-gray-400 hover:text-[var(--color-accent)] transition-colors">
              ...
              <div className="aspect-[4/5] rounded-3xl overflow-hidden bg-white/10 dark:bg-black/60 backdrop-blur-2xl p-4 rotate-3 hover:rotate-0 transition-transform duration-500">
                {profile.profile_image ? (
                  ...
                  <div className="w-full h-full bg-gray-200 dark:bg-gray-800 rounded-2xl flex items-center justify-center">
                    <i className="ph ph-user text-6xl text-gray-400"></i>
                  </div>
                )}
              </div>
            </div>
      ...
      <section id="skills" className="py-24 overflow-hidden bg-gray-100 dark:bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col gap-6 reveal-up active overflow-visible">
          <div className="relative w-full overflow-x-hidden fade-edges pause-on-hover mb-4 md:mb-8 order-1">
            <div className="animate-marquee whitespace-nowrap flex items-center gap-12 py-4 px-4">
              {[...skills, ...skills, ...skills, ...skills].map((skill: any, idx) => (
                <div key={idx} className="flex items-center gap-3 text-3xl font-bold text-gray-400 hover:text-black dark:hover:text-white transition-colors cursor-default">
                  {skill.icon_svg ? (
          ...
          <div className="flex items-center gap-4 pl-2 md:pl-8 mt-4 md:mt-8 order-2">
            ...
            <div className="shrink-0 w-20 h-20 md:w-28 md:h-28 text-gray-500 dark:text-gray-400 transform -translate-y-4 md:-translate-y-8 flex items-center justify-center pointer-events-none">
        ...
        <section id="mini-projects" className="py-16 pb-32">
          <div className="max-w-7xl mx-auto px-6 mb-12 reveal-up active">
            <h2 className="text-3xl md:text-4xl font-bold flex items-center gap-4">
                Mini Projects <span className="text-gray-400 text-lg font-normal">/ experiments</span>
            </h2>
          </div>
          <div className="max-w-7xl mx-auto px-6">
                ...
                <div key={i} className="group bg-white/10 dark:bg-black/60 backdrop-blur-2xl rounded-3xl p-8 flex flex-col hover:-translate-y-2 transition-all duration-300 reveal-up active border border-white/40 dark:border-white/10 hover:border-[var(--color-accent)] hover:shadow-2xl hover:shadow-[var(--color-accent)]/20">
                  ...
                  {project.github_url && (
                    <div className="pt-4 border-t border-gray-100 dark:border-gray-800 mt-auto">
                      <a href={project.github_url} target="_blank" aria-label="GitHub Repository" className="text-gray-400 hover:text-black dark:hover:text-white transition-colors flex items-center gap-2 text-sm">
                        <i className="ph ph-github-logo text-xl"></i>
              ...
              <div key={i} className="reveal-up active p-6 md:p-8 bg-white/10 dark:bg-black/60 backdrop-blur-2xl rounded-2xl border border-white/20 dark:border-white/10 hover:border-[var(--color-accent)] transition-all group">
                <div className="flex flex-col md:flex-row items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-500 text-sm mb-4 font-mono">{edu.start_date} – {edu.end_date}</p>
                    {edu.grade && (
      ...
      <section id="contact" className="py-32 md:py-48 relative overflow-hidden bg-white dark:bg-[#050505]">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10 reveal-up active">
          <p className="text-sm md:text-base text-gray-500 mb-8 font-medium uppercase tracking-[0.3em]">Got a project in mind?</p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 max-w-4xl mx-auto border-t border-gray-200 dark:border-white/10 pt-16">
            ...
            {profile.github_url && (
              <a href={profile.github_url} target="_blank" className="group relative flex flex-col items-center gap-2 hover:-translate-y-2 transition-transform duration-300">
                ...
                <span className="text-sm text-gray-500">View my code</span>
              </a>
            )}
          </div>
        </div>
